...
def load_model():
    try:
        ...
        model = load('crop_model.joblib')  # Note the file extension change
        le = load('label_encoder.joblib')   # Note the file extension change
        return model, le
...
# (Only the loading mechanism above has changed)
# [Keep all your existing UI code, form handling, etc.]
